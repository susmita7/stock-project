...
<head>
    ...
    <title>Dashboard | Stock Units</title>
        ...
        <div class="side_menu" id="menu">
            ...
            <div class="tabs">
                <div class="con_tabs">
                    ...
                    <div class="panel">
                        <a href="recurring_issue.php">Reccuring</a>
                ...
                <div class="college">
                    <div class="heading_btn">
                        ...
                        <div class="item_unit_btn">
                            ...
                            <!-----------------------------------------add unit+item btn---------------------------------->
                            <a id="add_item" type="button" onclick="overlay_add()">Add Units</a>
                            <a id="add_unit" type="button" href="stock_item.php">Add Items</a>
