...
<head>
    ...
    <title>Dashboard | Non reccuring Stock</title>
                ...
                <div class="college">
                    <div class="heading_btn">
                        <div class="icon_heading">
                            ...
                            <h1>Stock Register For Non Reccurring Stocks</h1>
                        </div>
                        <div class="item_unit_btn">
                            ...
                            <!------------------------------ add+issue btn--------------------------------------->
                            <a id="add_item" href="#" onclick="overlay_add()">Add Stocks</a>
                            <a id="add_unit" href="non_recurring_issue.php">Issue Stock</a>
                        </div>
                    </div>
                    <!----------------------------------table--------------------------------------->
