...
<body>
                    ...
                    <div class="form_base">
                        ...
                        <div class="main_form">
                            ...
                            <form id="form1" method="POST" autocomplete="off">
                                ...
                                <div class="input_box">
                                    <input type="email" id="sup_admin_email" required>
    ...
    $(document).ready(function (e){
        $( "#form1").on('submit', function (e) {
            ...
            var sup_admin_email=$('#sup_admin_email').val();
       
            if (!validateEmail(sup_admin_email)) {  
                swal.fire("Oops", "Please enter a valid Email Id", "warning");
            } else if (sup_admin_email.trim() == "") { 
              ...
              $.ajax({
                    ...
                    type: "POST",
                    data: { sendotp:1,sup_admin_email:sup_admin_email },
    ...
    $(document).ready(function (e){
        ...
        var sup_admin_password=$('#pass1').val();
        var sup_admin_password2=$('#pass2').val();
