 ...
 <!-----------------------------------------date-------------------------------------->
            ...
            <div class="content">
                ...
                <div id="info_profile" class="base_profile">
                    ...
                    <!----------------- show the profile info div here
                        ---------------------->
                        ...
                        <div class="main_update">
                            ...
                            <form action="<?php echo htmlspecialchars("profile");?>" method="POST" autocomplete="off" enctype="multipart/form-data">
                                ...
                                <div class="box">
                                    ...
                                    <input type="hidden" name="sup_admin_id" id="sup_admin_id" required>
                    ...
                    <div class="password_profile_page">
                        ...
                        <div class="main_pass">
                            ...
                            <form id="resetform" method="POST" autocomplete="off">
                                ...
                                <input type="hidden" id="sup_admins_id" required>
            ...
            if (!file_exists($target_file)) {
               ...
               $fire = mysqli_query($con,$query); //or die("can not update data .".mysqli_error($con));
                ...
                if ($fire) {
                    ...
                    if (!empty($row['sup_admin_img_link'])) {
                        if (file_exists($row['sup_admin_img_link'])) {
                            unlink($row['sup_admin_img_link']);
                        }
                    }
                    

                    //upload pic to the folder
                ...
                echo '<script type="text/javascript"> swal("Oops", "Sorry, image file already exists!", "error");</script>';
            }
          }else{
