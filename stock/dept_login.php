...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="css/mq_home(login).css">
...
<body>
        ...
        <div class="middle">
            ...
            <div class="div-2 rect">
                ...
                <div class="detail">
                    ...
                    <h3 id="para">Click on the icon to login with your email and password!</h3>
                </div>
            </div>
    ...
    <div class="container-3" id="overlay-admin">
        ...
        <div class="form_base">
            ...
            <div class="main_form">
                <!------------------------------------------------email & password--------------------------->
                <form id="form1" action="./department admin/login.php" method="POST" autocomplete="off">
    ...
    <div class="container-4" id="overlay-EU">
        ...
        <div class="form_base">
            ...
            <div class="main_form">
                <!------------------------------------------------email & password--------------------------->
                <form id="form2" action="./expert user/login.php" method="POST" autocomplete="off">
                    <div class="input_box">
...
<!---
    ...
    $(document).on("submit", "#form1", function (e) {
        ...
        if(dept_admin_email.trim() == "" || dept_admin_password.trim() == ""){
          ...
          $.ajax({
            url:"./department admin/login.php",
            type: "POST",
            ...
            success:function(result){
                ...
                if (gets.icon=="error"){
                    ...
                    title: 'Signed in successfully'
                           ...
                           window.location.href = "./expert user/home";
                        });
                    }
                }
            });
