...
<head>
    ...
    <title>Non Recurring Stock Add | Stockpile</title>

    <!--------------------------------------------------css link----------------------------------------------------------->
    <link rel="stylesheet" type="text/css" href="css/non_recurring_add.css">
         ...
         <!-----------------------------------------side menu open close-------------------------------------->
            ...
            <div class="tabs">
                <div class="con_tabs">
                    ...
                    <p type="button" class="accordion con_tabs_links ac"><i class="fas fa-plus-square"></i> Add
                        Stock</p>
                    <div class="panel">
                ...
                <div class="college">
                    <div class="heading_btn">
                        ...
                        <div class="icon_heading">
                            ...
                            <h1>Stock Register For Non Recurring Stock</h1>
                        </div>
                        ...
                        <div class="item_unit_btn">
                            ...
                            <a id="add_unit" type="button" href="non_recurring_issue">Issue Stock</a>
                        </div>
                    </div>

                    <!---------------------------------------table---------------------------------->
                    <div id="non_recurring_records" class="table-responsive">
                        
                        <!----------------- show stock register non-recurring here
                        ---------------------------> 
        ...
        function showStocks() {
            ...
            $.ajax({
                ...
                success:function(data,status){
                    $('#non_recurring_records').html(data);
                }
            });
        }
    </script>
