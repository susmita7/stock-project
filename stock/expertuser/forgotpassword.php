...
<head>
    ...
    <title>Expert User Forgot Password | Stockpile</title>
...
<body>
                    ...
                    <div class="form_base">
                        ...
                        <div class="main_form">
                            ...
                            <form id="form1" method="POST" autocomplete="off">
                                ...
                                <div class="input_box">
                                    <input type="email" id="eu_email" required>
        ...
        $( "#form1").on('submit', function (e) {
            ...
            if (!validateEmail(eu_email)) {  
              ...
              $.ajax({
                    ...
                    type: "POST",
                    data: { sendotp:1,eu_email:eu_email },
    ...
    $(document).ready(function (e){
        ...
        var eu_password=$('#pass1').val();
        var eu_password2=$('#pass2').val();
