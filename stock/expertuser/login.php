...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['login'])) {
    ...
    if (isset($_POST['eu_email']) && isset($_POST['eu_password'])) {
        ...
        $query = "SELECT * FROM expert_user INNER JOIN department ON expert_user.dept_id=department.dept_id WHERE eu_email ='$eu_email' AND eu_password ='$eu_password'";
