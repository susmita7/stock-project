...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['login'])) {
    ...
    if (isset($_POST['dept_admin_email']) && isset($_POST['dept_admin_password'])) {
        ...
        $query = "SELECT * FROM department_admin INNER JOIN department ON department_admin.dept_id=department.dept_id WHERE dept_admin_email ='$dept_admin_email' AND dept_admin_password ='$dept_admin_password'";
