...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['add'])) {
    ...
    if (mysqli_num_rows($fire) == 0) {
        ...
        $query = "INSERT INTO `balance_stock_non_recurring`(`used_for`, `name`, `quantity`, `unit`, `updated`, `reorder_point`, `dept_id`) VALUES ('$used_for','$particular_name','$quantity','$unit','$updated','$reorder_point','$dept_id')";
