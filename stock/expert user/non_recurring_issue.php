...
<head>
    ...
    <title>Issue Non-Reurring Stock | Stockpile</title>
                        ...
                        <div class="main_add_clg">
                            ...
                            <form id="form1" method="POST" autocomplete="off">
                                ...
                                <div class="row">
                                    <div class="col">
                                        <p>Remarks</p>
                                        <input type="text" id="remarks" class="form-control form-control-sm" placeholder="Remarks / Purpose" required>
                                    </div>
                                    <div class="col">
                                        <p>Receiver's Name</p>
                                ...
                                <div class="row">
                                    <div class="col">
                                        ...
                                        <select id="receiver_dept" class="form-control form-control-sm" required>
                                            ...
                                            <?php
                                              ...
                                              while ($dept = mysqli_fetch_array($fire)) {
                                                ?>
 ...
 <!---------------------------------------overlay for damage------------------------------------->
    ...
    <script type="text/javascript">
      /*function getQuantity() {
        ...
        var item=$("#particular_name").val();
        var unit=$("#unit").val();
        if (item!='' && unit!='') {
          $.ajax({
              url:'action2.php',
              type:'POST',
              data: { item : item, unit : unit},
    ...
    $(document).on("submit", "#form1", function (e) {
       ...
       if(used_for.trim() == "" || particular_type.trim() == "" || particular_name.trim() == "" || unit.trim() == "" || remarks.trim() == "" || receiver_name.trim() == "" || receiver_dept.trim() == "" || contact_no.trim() == ""){
          swal("Oops", "Form fields cannot be empty!", "warning");
          ...
          $.ajax({
            url:"action_non_recurring_issue.php",
            type: "POST",
            data: { add:1,used_for:used_for,particular_type:particular_type,particular_name:particular_name,unit:unit,previous_stock:previous_stock,issued_quantity:issued_quantity,remarks:remarks,receiver_name:receiver_name,receiver_dept:receiver_dept,contact_no:contact_no,dept_id:dept_id },
    ...
    $(document).on("submit", "#damageform", function (e) {
       ...
       if(damage_reason.trim() == ""){
          ...
          $.ajax({
            url:"action_non_recurring_issue.php",
            type: "POST",
            data: { damage:1,receiver_id:receiver_id,damage_quantity:damage_quantity,damage_reason:damage_reason,dept_id:dept_id },
            success:function(result){
