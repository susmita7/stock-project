...
<head>
    ...
    <title>College Admin Forgot Password | Stockpile</title>
...
<body>
    ...
    <div class="wrapper">
                    ...
                    <div class="form_base">
                        ...
                        <div class="main_form">
                            ...
                            <form id="form1" method="POST" autocomplete="off">
                                <h1>Enter your valid email address to recieve a verification code.
                                </h1>
                                <div class="input_box">
                                    <input type="email" id="clg_admin_email" required>
                            ...
                            <form id="form2" method="POST" autocomplete="off">
                                ...
                                <div class="expire">
                                    ...
                                    <h2>Your code Expire in : 2 mins</h2>
                                </div>
                            ...
                            <form id="form3" method="POST" autocomplete="off">
                                ...
                                <input type="hidden" id="clg_admins_id">
        ...
        <div class="down">
            <ul class="back_btn">
                <li class="back"><a href="login"><i class="fas fa-arrow-circle-left"></i>BACK</a>
                </li>
            </ul>
        </div>
    ...
    $(document).ready(function (e){
        $( "#form1").on('submit', function (e) {
            ...
            if (!validateEmail(clg_admin_email)) {  
                swal.fire("Oops", "Please enter a valid Email Id", "warning");
            } else if (clg_admin_email.trim() == "") { 
              ...
              $.ajax({
                    ...
                    type: "POST",
                    data: { sendotp:1,clg_admin_email:clg_admin_email },
    ...
    $(document).ready(function (e){
        ...
        var clg_admin_password=$('#pass1').val();
        var clg_admin_password2=$('#pass2').val();
