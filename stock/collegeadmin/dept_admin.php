...
<body onload="renderDate()">
         ...
         <div class="side_menu" id="menu">
            ...
            <div class="tabs">
                <div class="con_tabs">
                    ...
                    <a href="dept_admin" class="con_tabs_links ac"><i class="fas fa-user"></i>&nbsp Dept Admins</a>
                ...
                <div class="college">
                    <div class="heading_add_btn">
                        <div class="icon_heading">
                            ...
                            <h1>Department Admins Under <?php echo $_SESSION["clg_name"] ;?></h1>
                        </div>
    ...
    $(document).on("submit", "#form1", function (e) {
       ...
       if(dept_admin_first_name.trim() == "" || dept_admin_last_name.trim() == ""){
          ...
          $.ajax({
            url:"action_dept_admin.php",
            type: "POST",
            data: { add:1,dept_admin_first_name:dept_admin_first_name,dept_admin_last_name:dept_admin_last_name,dept_admin_email:dept_admin_email,dept_admin_password:dept_admin_password,dept_admin_password2:dept_admin_password2,dept_id:dept_id },
            success:function(data){
                var getmsgs=$.parseJSON(data);
                swal(""+getmsgs.title , ""+getmsgs.text ,""+getmsgs.icon);
                $("#dept_admin_first_name").val("");
                $("#dept_admin_last_name").val("");
    ...
    <!--------------------- get the dept admin details to be updated 
        -------------------------------------->
    <script type="text/javascript">
    ...
    <!-------------------------------- dept admin delete ajax request 
        -------------------------------->
    <script type="text/javascript">
