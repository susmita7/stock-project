    ...
    $(document).on("submit", "#form1", function (e) {
       ...
       if(eu_first_name.trim() == "" || eu_last_name.trim() == ""){
          ...
          $.ajax({
            url:"action_expert_user.php",
            type: "POST",
            data: { add:1,eu_first_name:eu_first_name,eu_last_name:eu_last_name,eu_email:eu_email,eu_password:eu_password,eu_password2:eu_password2,dept_id:dept_id,clg_id:clg_id },
