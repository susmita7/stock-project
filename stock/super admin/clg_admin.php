        ...
        <div class="side_menu">
            ...
            <div class="tabs">
                <div class="con_tabs">
                    ...
                    <a href="clg_admin" class="con_tabs_links ac"><i class="fas fa-user"></i>&nbsp
                        Clg_admins</a>
    ...
    $(document).on("submit", "#form3", function (e) {
       ...
       if(clg_admin_first_name.trim() == "" || clg_admin_last_name.trim() == ""){
          ...
          $.ajax({
            url:"action_clg_admin.php",
            type: "POST",
            data: { clg_admin_first_name:clg_admin_first_name,clg_admin_last_name:clg_admin_last_name,clg_admin_email:clg_admin_email,clg_admin_password:clg_admin_password,clg_admin_password2:clg_admin_password2,clg_id:clg_id },
    ...
    /*    function deleteadmin(delid) {
            $.ajax({
                ...
                success:function(d){
                    var res=$.parseJSON(d);
                    if (res.icon=="error"){
                        swal(""+get.title , ""+get.text ,""+get.icon);
                    }else{
                        swal(""+response.title , ""+response.text ,""+response.icon);
                        showCollegeadmins();
                    }
