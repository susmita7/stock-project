...
<head>
    ...
    <title>Super Admin Login | Stockpile</title>

    <!--------------------------------------------------css link----------------------------------------------------------->
    <link rel="stylesheet" type="text/css" href="css/login.css">
    <link rel="stylesheet" type="text/css" href="css/mq_login1.css">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="heading_text">
                        <h1 id="text_left">SUPER ADMIN</h1>
                        ...
                        <div class="main_form">
                            ...
                            <form id="loginform" method="POST">
                                <div class="input_box">
                                    ...
                                    <!------------------------------ email ---------------------------->
                                    <input type="email" id="admin_email" value="<?php if(isset($_COOKIE["email"])) { echo $_COOKIE["email"]; } ?>" autocomplete="off" required>
...
<!---
   ...
   <!------------------------------------ email validation
    ...
    $(document).on("submit", "#loginform", function (e) {
        ...
        var sup_admin_email=$('#admin_email').val();
        var sup_admin_password=$('#pass').val();
        ...
        if(sup_admin_email.trim() == "" || sup_admin_password.trim() == ""){
          ...
          $.ajax({
            ...
            type: "POST",
            data: { login:1,sup_admin_email:sup_admin_email,sup_admin_password:sup_admin_password,testing:testing },
